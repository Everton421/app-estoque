            ...
            {  item.fotos.length > 0 && item.fotos[0].link ?
                        (<Image
                             ...
                             style={{ width: 100, height: 100,  borderRadius: 5,}}
                              resizeMode="contain"
                            />) :(
                              <MaterialIcons name="no-photography" size={40} color={  "#000"  } />
                            )
                 }
          ...
          <View style={{ backgroundColor: "rgba(0, 0, 0, 0.7)", flex: 1 }}>
            ...
            <View style={styles.searchContainer}>
                ...
                <View
                  ...
                  <TextInput
                    style={{  backgroundColor: "#FFF",  borderRadius: 4,  width: "70%",fontWeight:'bold',   marginTop: 3, elevation:5, marginHorizontal: 5,
                    }}
